 ...
 * License.
 *
 * The Original Code is Mozilla Labs Tactile PDF.JS Reader.
 *
...
PR.Page = new Class({
	...
	render: function(version, bounds) {
		...
		console.log('onStartRendering', this.num);
	...
	onRenderComplete: function(e) {
		console.log('onRenderComplete', this.num, e || 'success');

		this.canvasList[this.version].setStyle('opacity', 1);
	...
	position: function() {
		...
		console.log('position ' + this.bounds.positioned || null);
